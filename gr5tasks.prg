...
Created on   : 16-May-2005
 Autor       : Inso Informática / Wictrix 2.0
*/
...
function main()
 ...
 // Accees control enviroment
   ...
   readWGet()
   wSet("_PROJECT","GR5")
   wSet("_BUILD_SRC_PROJECT",     12834)
   wSet("_BUILD_SRC_MODULE",        24)
   wSet("_BUILD_UI",      6191)
   wSet("_BUILD_DB",      1098)
   wSet("_PROJECT_VERSION","3.9.1")
   wSet("_PROGRAM_DEFAULT","daemon.wic")
   ...
   if empty(wSet("_USER_INTERFACE"))
      if gbWFL_AC
         ...
         wSet("_USER_INTERFACE","daemon.wic")
      endif
   endif
...
function wprogstruct(fcPROGRAM)
      ...
      elseif "envio.mnt.html" == fcPROGRAM
         return({"envio.mnt.html","text/html",.f.}) 
      elseif "parecer.mnt.html" == fcPROGRAM
         return({"parecer.mnt.html","text/html",.f.})
      elseif "unidade_medida.mnt.html" == fcPROGRAM
         return({"unidade_medida.mnt.html","text/html",.f.})  
      elseif "mnt.pasta.consultivo_seguro_precedente.html" == fcPROGRAM
         return({"mnt.pasta.consultivo_seguro_precedente.html","text/html",.t.})         
      elseif "mnt.pasta.consultivo_seguro_precedente.consultor_externo.html" == fcPROGRAM
         return({"mnt.pasta.consultivo_seguro_precedente.consultor_externo.html","text/html",.t.})  
      ...
      elseif "loja.mnt.html" == fcPROGRAM
         return({"loja.mnt.html","text/html",.f.})
      elseif "loja.lst.html" == fcPROGRAM
         return({"loja.lst.html","text/html",.f.})
      elseif "lojap.mnt.html" == fcPROGRAM
         return({"lojap.mnt.html","text/html",.f.})
      elseif "lojap.lst.html" == fcPROGRAM
         return({"lojap.lst.html","text/html",.f.})
      elseif "sch.loja.html" == fcPROGRAM
         return({"sch.loja.html","text/html",.f.})
      elseif "sch.lojap.html" == fcPROGRAM
         return({"sch.lojap.html","text/html",.f.})
      elseif "pagnet.alfa.html" == fcPROGRAM
         return({"pagnet.alfa.html","text/html",.f.})
//      elseif "psab.recurso.html" == fcPROGRAM
//         return({"psab.recurso.html","text/html",.f.})
// excluido por solicitação da celia em 24/7/2009 10:46:05                
...
/*      elseif "mnt.pasta.consultivo_seguro.html" == fcPROGRAM
      ...
      elseif "psab.consulente.html" == fcPROGRAM
         return({"psab.consulente.html","text/html",.t.})         
      elseif "pst.consultor_externo.html" == fcPROGRAM
         return({"psab.consultor_externo.html","text/html",.t.}) 
